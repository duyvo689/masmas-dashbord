            ...
            <div className="relative w-full flex">
                ...
                <div className="flex-none min-w-min mx-5 m-auto">
                    <div className="flex items-center justify-center mx-auto">
                        <Image className="" src="/img/flag.png" alt="" width={24}
                            height={24} />
                        <svg className="my-auto ml-5" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className="my-auto ml-5" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className="mb-2 my-auto mx-5" width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Image className="p-xl bg-indigo-200 rounded-full" width={38}
