                ...
                <div className="flex-none min-w-min mx-5 m-auto">
                    <div className="flex items-center justify-center mx-auto">
                        ...
                        <Image className="cursor-pointer" src="/img/flag.png" alt="" width={24}
                            height={24} />
                        {/* dark light */}
                        <svg className="my-auto ml-5 cursor-pointer hover:fill-slate-700" width="18" height="19" viewBox="0 0 18 19" fill="#8592A3" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* menu */}
                        <svg className="my-auto ml-5 cursor-pointer hover:fill-slate-700" width="18" height="18" viewBox="0 0 18 18" fill="#8592A3" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="relative">
                            <svg className="mb-2 my-auto mx-5 cursor-pointer hover:fill-slate-700" onClick={showNotification} width="27" height="28" viewBox="0 0 27 28" fill="#8592A3" xmlns="http://www.w3.org/2000/svg">
