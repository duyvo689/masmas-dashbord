    ...
    return (
        <div className="p-6">
            <div className="flex justify-between">
                ...
                <svg className="cursor-pointer hover:fill-slate-700" width="4" height="15" viewBox="0 0 4 15" fill="#8592A3" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex xl:gap-5 gap-2 flex-col">
                ...
                <div className="flex items-center p-4 bg-white rounded-lg border-indigo-300 border-solid border justify-between">
                    <input checked id="disabled-checked-checkbox" type="checkbox" value="" className="cursor-pointer w-4 h-4 accent-indigo-500 focus:accent-indigo-500" />
                    <label htmlFor="disabled-checked-checkbox" className="ml-2 text-xs font-extralight highlight-indigo">+$75</label>
                </div>
                <div className="flex items-center p-4 bg-white rounded-lg border-indigo-300 border-solid border justify-between">
                    <input id="disabled-checkbox" type="checkbox" value="" className="cursor-pointer w-4 h-4 accent-indigo-500 focus:accent-indigo-500" />
                    <label htmlFor="disabled-checkbox" className="ml-2 text-xs font-extralight highlight-green">+$125</label>
                </div>
                <div className="flex items-center p-4 bg-white rounded-lg border-indigo-300 border-solid border justify-between">
                    <input disabled id="disabled-checkbox" type="checkbox" value="" className="cursor-pointer w-4 h-4 accent-indigo-500 focus:accent-indigo-500" />
